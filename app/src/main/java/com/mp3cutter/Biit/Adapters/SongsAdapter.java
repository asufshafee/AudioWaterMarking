package com.mp3cutter.Biit.Adapters;
...
import com.mp3cutter.Biit.Views.BubbleTextGetter;
...
public class SongsAdapter extends RecyclerView.Adapter<SongsAdapter.ItemHolder> implements BubbleTextGetter {
    ...
    public SongsAdapter(RingdroidSelectActivity ringdroidSelectActivity, List<SongsModel> data, String Marked) {
    ...
    public void updateData(List<SongsModel> data) {
        this.mData = data;
